 ...
 * pseudocode that you are going to get from the video.
 *
 * @author Mr. Dagler
 * @author
 */
...
class LinearSearch
{
   public static void main(String[] args)
   {
      ...
      int[] vals = {1, 4, 11, 14, 16, 25, 30, 33, 34, 37, 41, 42, 51, 52, 
		 57, 61, 62, 63, 64, 74, 75, 77, 80, 82, 84, 85, 90, 91, 98, 
		 100};

         valueToFind = 85;
         index = linearSearch(vals, valueToFind);
         if(index == -1)
   		{
